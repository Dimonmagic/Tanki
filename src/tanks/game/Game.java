...
float speed=3;
		...
		private void render() {
			...
			graphics2D.fillOval(550, 350 + (int) (Math.sin(deltaSpeed) * 200), 200,
					300);
			graphics2D.fillOval(500, 400 + (int) (Math.sin(deltaSpeed) * 200), 100,
					30);
			graphics2D.fillOval(450, 400 + (int) (Math.sin(deltaSpeed) * 200), 100,
					30);
			graphics2D.setColor(Color.yellow);
			graphics2D.fillOval(350 + (int) (Math.sin(delta) * 200), 250, 100, 100);
			graphics2D.setColor(Color.red);
			graphics2D.drawRect(150, 250 + (int) (Math.sin(delta) * 200), 500, 300);
